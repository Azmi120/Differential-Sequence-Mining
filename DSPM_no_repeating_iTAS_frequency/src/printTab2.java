...
public class printTab2 {
	public static void main(String[] args) throws FileNotFoundException, IOException {
	//args[0]: "replacemulti" or "regular"
	//args[1]: all activity "EQXTUV"
	//args[2]: gap
	//args[3]: select_top
	...
	//filter this with p, then rank with t value.
		...
		String output_file="C:\\Users\\Dan Lv\\Documents\\"+args[0]+"_"+args[1]+"_g"+args[2]+"_top"+args[3]+"_e"+args[4]+"_p"+args[5]+"_t"+args[6]+"_notail.csv";
		tools t=new tools();
